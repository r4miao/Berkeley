...
The Berkeley Highway SC-45 Corridor (BSC-45) is a narrow strip of land in the northwest corner of Berkeley County, spanning about 450 square miles. It sits between two major hydrologic systems that shape its unique landscape: Lake Marion and the Santee River wetlands to the north, and Lake Moultrie to the south. These natural features form barriers that limit north-south travel, making the east-west bound Highway SC-45 the main route of daily commune and emergency evacuation for the area's 25,000 residents. BSC-45 includes 10 census tracts, 8 of which are identified as disadvantaged communities by the EJScreen tool. These communities bear compound challenges like socioeconomic vulnerability, workforce development crisis, infrastructural inadequacy and energy burden, environmental and climate hazards, and health disparities.

In terms of **socioeconomic vulnerability**, over 20% of the population lives in poverty, and nearly half (48%) are below 150% of the federal poverty line. The area has a predominantly Black population, accounting for over 45%, but educational attainment is low, with only 12% of residents holding a college degree.

The region is also experiencing a **workforce development crisis**, exacerbated by an underfunded school system. All five public schools in the area are Title I schools, with an average pupil poverty rate of 78%. The inadequate school system has imposed long-term constraints on workforce development. Among the two high schools, only 20% of students are considered college-ready. The percentages of graduates who have completed a Career and Technical Education (CTE) program and earned industry-recognized certifications are 12.5% and 8.6%, respectively. Unfortunately, the future workforce outlook is not promising, as students in the three elementary schools show little indication of improving these trends. For example, ...

**Infrastructural inadequacy and energy burden**. a direct manifestation of the socioeconomic vulnerability is the infrastructural inadequacy. To date, there is not a regional resilience hub that could provide emergence service to the area population. . Three of the public schools that were designated as the public emergency shelters nevertheless were not equipped with resilience power supply solutions or energy-efficient air filtration systems to ensure air quality for the crowded public space.

Of the 2,000 housing units, nearly half are mobile homes that suffer from poor insulation and outdated utilities, leading to low energy efficiency. Just 30% of homes use electricity as their primary heating source, and many residents are burdened by high energy costs, with households spending more than 10% of their income on energy. For low-income families, this burden can reach as high as 20%, with over 20% of these households relying on wood for heating. The region also experiences extreme heat, enduring more than 80 days each year with temperatures above 90 degrees.
...
**Health disparities**. There is a higher-than-average prevalence of current asthma, with more than 11% of the population affected, exceeding national averages. the obesity rates range from 42% to 52% for different census tracts. Finally, 75% of the area is classified as a food desert, where many households lack access to a vehicle and live more than half a mile from the nearest supermarket, or they reside more than 20 miles from the closest grocery store.
